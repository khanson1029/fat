...
export interface IDisplayStringsClient {
    getHello(): Observable<string>;
    getRand(): Observable<string>;
}

@Injectable({
    providedIn: 'root'
})
export class DisplayStringsClient implements IDisplayStringsClient {
    ...
    getHello(): Observable<string> {
        let url_ = this.baseUrl + "/api/DisplayStrings/hello";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.proccessResponseString(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.proccessResponseString(response_ as any);
                } catch (e) {
    ...
    protected proccessResponseString(response: HttpResponseBase): Observable<string> {
        ...
        if (status === 200) {
            ...
            let resultData200 = _responseText === "" ? "": _responseText;
    ...
    getRand(): Observable<string> {
        let url_ = this.baseUrl + "/api/DisplayStrings/rand";
        url_ = url_.replace(/[?&]$/, "");
